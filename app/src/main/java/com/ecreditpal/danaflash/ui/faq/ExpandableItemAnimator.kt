...
class ExpandableItemAnimator : DefaultItemAnimator() {
    ...
    override fun recordPreLayoutInformation(
        ...
        return if (viewHolder is FaqAdapter.ViewHolder.HeaderVH) {
            HeaderItemInfo().also {
    ...
    override fun animateChange(
        ...
        if (preInfo is HeaderItemInfo && postInfo is HeaderItemInfo && holder is FaqAdapter.ViewHolder.HeaderVH) {
            ObjectAnimator
                .ofFloat(
                    holder.icExpand,
                    View.ROTATION,
...
class HeaderItemInfo : RecyclerView.ItemAnimator.ItemHolderInfo() {
    ...
    override fun setFrom(holder: RecyclerView.ViewHolder): RecyclerView.ItemAnimator.ItemHolderInfo {
        if (holder is FaqAdapter.ViewHolder.HeaderVH) {
